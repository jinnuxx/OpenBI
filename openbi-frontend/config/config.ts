...
export default defineConfig({
  ...
  request: {
    ...
    errorConfig: {
      // 错误处理配置
      errorField: 'status', // 根据后端返回的数据结构进行配置
    },
    timeout: 15000,
    // 在这里配置 baseURL
    // baseURL: 'http://localhost:8101', // 替换成你需要的 baseURL：http://122.51.230.61/
    baseURL: 'http://122.51.230.61:8101', // 替换成你需要的 baseURL：http://122.51.230.61
